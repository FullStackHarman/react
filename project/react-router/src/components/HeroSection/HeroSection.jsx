        ...
        <p className="text-xs font-medium md:text-sm">
          ...
          <span className="ml-2 cursor-pointer font-bold">Read More →</span>
                    ...
                    <p className="mt-8 max-w-3xl text-lg text-gray-700">
                        They nudge you for that extra water refill. Notice when you haven't slept well. Remind you to take a break from the screen. Celebrate your healthy choices with you. Their care whispers in the little things.
                    </p>
                    <div className="mt-8">
                        <button
                            type="button"
